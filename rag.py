...
def ingest_document(
    ...
    """Load document (Docling or fallback), split, embed (all-mpnet-base-v2), store in Neon. Returns status message."""
    ...
    return f"Added {len(chunks)} chunk(s) from {filename or 'document'} to your documents."
