...
- **Image generation:** When the user asks to create, draw, or generate an image, call generate_image(prompt) with a clear description. You will get a link; share it so they can open and view the image. Free (Pollinations.ai).
